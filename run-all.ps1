# To'liq qayta ishga tushirish: 8000, 3000 portlarni tozalash, keyin Backend va Frontend.
$ErrorActionPreference = 'SilentlyContinue'

Write-Host "Portlarni tozalash: 8000 (backend), 3000 (frontend)..."
...
Write-Host "To'liq ishga tushirildi: Backend (8000), Frontend (3000)."
