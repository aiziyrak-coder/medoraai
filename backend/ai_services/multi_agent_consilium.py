...
def _final_consensus(
    ...
    user = (
        ...
        '  "folk_medicine": {\n'
        '    "intro": "Mazmunli kirish: tanlangan o\'simliklar va klinik mosligi (manba qavs ichida, https://...). Boshqa bo\'limga yo\'naltiruvchi matn YO\'Q.",\n'
        ...
        '    "intro": "Tashxisga mos parhez va profilaktika kirishi (manba bilan, https://...). \'Pastda/quyida\' YO\'Q.",\n'
        '    "dietary_guidelines": ["tuz nazorati (WHO, https://...)", "suv..."],\n'
        '    "prevention_measures": ["jismoniy faollik (SSV, https://...)", "skrining..."],\n'
