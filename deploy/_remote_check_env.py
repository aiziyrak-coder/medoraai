...
c.connect("167.71.53.238", username="root", password=__import__("os").environ.get("DEPLOY_SSH_PASSWORD", os.environ["SERVER_PASSWORD"]), timeout=60, allow_agent=False, look_for_keys=False)
cmd = """
