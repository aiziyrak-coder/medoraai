            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:items-stretch">
                ...
                {onOpenUziUtt && (
                    <div className="lg:col-span-12">
                        ...
                        >
                            <div className="absolute inset-0 opacity-[0.07] pointer-events-none hex-grid-bg" aria-hidden />
                            <span
                            ...
                            <div className="relative z-[1] flex-1 min-w-0">
                                <p className="text-[11px] font-mono font-bold tracking-wider uppercase leading-none mb-0.5" style={{ color: '#5eead4' }}>
                                ...
                                <p className="text-[10px] sm:text-xs leading-snug mt-0.5 line-clamp-2 sm:line-clamp-none" style={{ color: 'rgba(180,220,245,0.82)' }}>
                                    {trSafe('uzi_utt_strip_subtitle')}
                                </p>
                            </div>
                            <span className="relative z-[1] flex-shrink-0 inline-flex items-center gap-0.5 text-xs sm:text-sm font-bold text-cyan-300 group-hover:text-cyan-200 transition-colors">
                                {trSafe('uzi_utt_open')}
